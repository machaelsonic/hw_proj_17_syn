...
#
nios2-flash-programmer "../flash/plc_design_epcs_flash_controller_0.flash" --base=0x21000 --epcs --sidp=0x221F0 --id=0x1 --timestamp=1510637477 --device=1 --instance=0 '--cable=USB-Blaster on localhost [USB-0]' --program 
...
#
nios2-flash-programmer "../flash/uart_rcv_epcs_flash_controller_0.flash" --base=0x21000 --epcs --sidp=0x221F0 --id=0x1 --timestamp=1510637477 --device=1 --instance=0 '--cable=USB-Blaster on localhost [USB-0]' --program 
