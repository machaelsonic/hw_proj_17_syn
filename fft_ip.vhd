...
ARCHITECTURE SYN OF fft_ip IS
	...
	COMPONENT asj_fft_si_se_so_b_fft_121
	GENERIC (
		nps	: NATURAL;
		bfp	: NATURAL;
		nume	: NATURAL;
...
BEGIN
	...
	asj_fft_si_se_so_b_fft_121_inst : asj_fft_si_se_so_b_fft_121
	GENERIC MAP (
		nps => 256,
		bfp => 1,
		nume => 1,
...
-- Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FFTModelClass"  active_core="asj_fft_si_se_so_b_fft_121" >
...
-- Retrieval info:      <PRIVATE name = "NUM_LE" value="2438"  type="INTEGER"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "NUM_CALC_CYCLES" value="262"  type="INTEGER"  enable="1" />
-- Retrieval info:      <PRIVATE name = "NUM_BLK_THROUGHPUT_CYCLES" value="775"  type="INTEGER"  enable="1" />
